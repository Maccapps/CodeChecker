<?php
/**
 * Generic_Sniffs_Functions_MultiLineFunctionDeclarationSniff.
 *
 * PHP version 5
 *
 * @category  PHP
...
if (class_exists('Generic_Sniffs_Functions_FunctionDeclarationSniff', true) === false) {
    $error = 'Class Generic_Sniffs_Functions_FunctionDeclarationSniff not found';
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Generic_Sniffs_Functions_MultiLineFunctionDeclarationSniff extends Generic_Sniffs_Functions_FunctionDeclarationSniff
{
